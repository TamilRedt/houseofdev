...
export const portfolioProjects: PortfolioProject[] = [
  {
    title: "Sudersan Clinic",
    slug: "sudersan-clinic",
    category: "Healthcare",
    summary:
      "A clinic website and appointment workflow designed to improve patient trust, reduce phone coordination, and increase online bookings.",
    goals: ["Modernize patient-facing brand", "Enable online appointments", "Improve local search visibility"],
    features: ["Doctor profiles", "Appointment requests", "WhatsApp support", "Local business schema"],
    technologies: ["Next.js", "Supabase", "Server Actions", "Structured Data"],
    results: ["42% more appointment inquiries", "Faster patient intake", "Improved mobile engagement"],
    palette: "from-emerald-500 to-cyan-500",
  },
  {
    title: "Urban Taste Restaurant",
    slug: "urban-taste-restaurant",
    category: "Restaurant",
    summary:
      "A premium food brand site with menu browsing, table booking, offers, and conversion tracking.",
    goals: ["Showcase menu and ambience", "Enable table inquiries", "Promote seasonal offers"],
    features: ["Digital menu", "Booking form", "Offer landing pages", "Review highlights"],
    technologies: ["Next.js", "React Hook Form", "Zod", "Analytics"],
    results: ["31% uplift in booking requests", "More repeat offer visits", "Faster menu discovery"],
    palette: "from-amber-500 to-rose-500",
  },
  {
    title: "BuildPro Constructions",
    slug: "buildpro-constructions",
    category: "Construction",
    summary:
      "A construction portfolio platform with project galleries, inquiry flow, timeline proof, and lead qualification.",
    goals: ["Present completed work", "Capture project inquiries", "Build trust with commercial buyers"],
    features: ["Project galleries", "Inquiry qualification", "Timeline module", "Service pages"],
    technologies: ["Next.js", "PostgreSQL", "AWS", "SEO"],
    results: ["More qualified inquiries", "Improved proposal preparation", "Clearer project credibility"],
    palette: "from-slate-700 to-blue-500",
  },
  {
    title: "Smart Future Academy",
    slug: "smart-future-academy",
    category: "Education",
    summary:
      "An admissions-focused education website with program pages, inquiry management, blog content, and campus highlights.",
    goals: ["Increase admissions inquiries", "Showcase courses", "Improve parent confidence"],
    features: ["Program pages", "Admissions forms", "Student stories", "SEO blog"],
    technologies: ["Next.js", "Supabase", "Open Graph", "Server Actions"],
    results: ["Higher inquiry completion", "Better course visibility", "Simpler admissions follow-up"],
  ...
  },
  {
    ...
    category: "Corporate",
    summary:
      "A corporate technology website with solutions architecture, thought leadership, case studies, and partner-ready credibility.",
    goals: ["Position as a serious technology partner", "Clarify solution offerings", "Improve enterprise lead quality"],
    features: ["Mega menu", "Case studies", "Blog system", "Client portal concept"],
    technologies: ["Next.js", "Framer Motion", "Supabase", "Vercel"],
    results: ["Sharper enterprise positioning", "More structured sales conversations", "Better content scalability"],
