          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <div className="mt-8 grid gap-4">
                {jobs.map((job) => (
                  <div key={job.title} className="interactive-card rounded-lg border border-slate-200 p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300">
              ...
              <div className="interactive-card mt-6 rounded-lg border border-slate-200 bg-slate-50 p-5">
